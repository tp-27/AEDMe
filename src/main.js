...
// function geocode() {
//     var location = '401 beaumont cres Kitchener, ON'; 
//     axios.get('https://maps.googleapis.com/maps/api/geocode/json', {
//       params: {
//         address: location,
//         key: 'AIzaSyCzGghxXBLge_jHypQILU7-1evtXjBIUio'
//       }
//     })
//     // After getting request response - then do something
//     .then(function(response) {
//       // Log full response
//       console.log(response);

//       // Formatted coordinates
//       var coordinates = console.log(response.data.results[0].geometry.location.latitude);
//     })
